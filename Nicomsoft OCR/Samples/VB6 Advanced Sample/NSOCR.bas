...
'A VB6 wrapper class for NSOCR

'******************************************************************************
'                        Nicomsoft OCR DLL interface
'                    Copyright (c) 2010-2015 Nicomsoft
'                 Copyright (c) 2010-2015 Michael Kapustin
'                           www.nsocr.com
'******************************************************************************
    ...
    Public Const IMG_PROP_INVERTED = &H6          'image inversion flag after OCR_STEP_PREFILTERS step
